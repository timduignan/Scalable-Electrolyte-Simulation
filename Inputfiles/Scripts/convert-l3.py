...
def main():
    energyout = open("/scratch/tn51/ttd110/nequip-data/training/dataLiCl-COrem-DCR2SCAN-2p4M/energy.raw", "w")
    coordout = open("/scratch/tn51/ttd110/nequip-data/training/dataLiCl-COrem-DCR2SCAN-2p4M/coord.raw", "w")
    boxout = open("/scratch/tn51/ttd110/nequip-data/training/dataLiCl-COrem-DCR2SCAN-2p4M/box.raw", "w")
    forceout = open("/scratch/tn51/ttd110/nequip-data/training/dataLiCl-COrem-DCR2SCAN-2p4M/force.raw", "w")

    coord= readinput("/scratch/tn51/ttd110/CP2K/LiCl-DCR2SCAN-reftraj/LiCl-DCR2SCAN-full-pos-1.xyz")
    forceCP2K = readinputfrc("/scratch/tn51/ttd110/CP2K/LiCl-DCR2SCAN-reftraj/LiCl-DCR2SCAN-full-frc-1.xyz")
    energyCP2K=readinputlist("/scratch/tn51/ttd110/CP2K/LiCl-DCR2SCAN-reftraj/energy-full.dat")
    COforceLAMMPS = readinputlmps("/scratch/tn51/ttd110/LAMMPS/LiCl-2p4M-DCR2SCAN-COrerun/LiCl-R2SCAN-COalt-frc.lammpstrj")
    COenergylammps=readinputlist("/scratch/tn51/ttd110/LAMMPS/LiCl-2p4M-DCR2SCAN-COrerun/energy.dat")
    ...
    for i in range(0,nframes):
        print("---"+str(i))
        boxout.write("13.8674 0.0 0.0 0.0 13.8674  0.0 0.0 0.0 13.8674 \n")
